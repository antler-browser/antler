...
Antler implements the [IRL Browser Specification](https://antlerbrowser.com/irl-browser-specification), a specification for secure communication between IRL Browser apps and mini apps.
